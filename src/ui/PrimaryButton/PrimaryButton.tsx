    ...
    return (
        <div className='relative group'>
            ...
            <button className="button-primary py-[12px] px-[5px] sm:px-[40px] relative overflow-hidden font-medium text-gray-600 bg-white border border-gray-100 rounded-lg shadow-inner group">
                ...
                <span className="absolute top-0 left-0 w-0 h-0 transition-all duration-200 border-t-2 border-[#9f193f] group-hover:w-full ease"></span>
                <span className="absolute bottom-0 right-0 w-0 h-0 transition-all duration-200 border-b-2 border-[#9f193f] group-hover:w-full ease"></span>
