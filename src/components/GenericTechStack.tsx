    ...
    <section className="py-20 px-4 sm:px-16 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-20 gap-8">
        {techCategories.map((category, index) => (
          <div
            key={index}
            className="group bg-white border border-gray-300 rounded-2xl p-6 shadow transition-shadow hover:shadow-lg duration-300  hover:border-[#9F1940] hover:bg-[#fff5f7] h-[250px] overflow-y-auto overflow-hidden custom-scrollbar"
          >
