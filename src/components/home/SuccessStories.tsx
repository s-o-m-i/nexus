                        ...
                        {caseStudies.map((study, index) => (
                            ...
                            >
                                <div className="bg-[#111111] rounded-2xl overflow-hidden">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-8">
                                            ...
                                            <div className="md:w-5/12 flex flex-col space-y-4">
                                                ...
                                                <div className="bg-white p-4 rounded-xl">
                                                    <div className="text-sm text-[#111111] mb-1">Result</div>
                                    ...
                                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-[#111111]/20 to-transparent rounded-full blur-3xl -ml-32 -mb-32 opacity-30"></div>
                                </div>
                            </motion.div>
                        ))}
                    </div>
