    ...
    return (
        <>
            <div className="bg-white rounded-lg shadow-lg p-8 relative max-w-xl mx-auto ">
                ...
                <h3 className="text-2xl font-bold text-[#111111] mb-6">Book a Free Consultation</h3>
                <form>
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#9f193f] text-[#fff] py-3 rounded-lg font-medium hover:bg-[#111111] transition-colors duration-300 flex items-center justify-center gap-2"
                    >
                        Submit Request
