            ...
            <section className="relative py-24 px-4 sm:px-8 md:px-16 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        ...
                        <h2 className='text-[32px] sm:text-[42px] font-bold text-[#111111] mb-6'>Why Choose Us for Design Services?</h2>
                    ...
                    <div className="mt-20 bg-[#111111] rounded-2xl p-4 py-8 sm:py-10 sm:p-10 text-white shadow-xl">
